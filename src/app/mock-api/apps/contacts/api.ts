...
import { contacts as contactsData, countries as countriesData, tags as tagsData, models as modelsData, tayeurs as tayeursData, clients as clientsData, commandes as commandesData } from 'app/mock-api/apps/contacts/data';
...
export class ContactsMockApi {
    ...
    private _models: any[] = modelsData;
    private _tayeurs: any[] = tayeursData;
    private _clients: any[] = clientsData;
    private _commandes: any[] = commandesData;
    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            .onPost('api/apps/contacts/client')
            .reply(() => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/contacts/commande')
            .reply(() => {
                // Generate a new contact
                const newCommande = {
                    id: FuseMockApiUtils.guid(),
                ...
                // Unshift the new contact
                this._commandes.unshift(newCommande);

                // Return the response
                return [200, newCommande];
            });
        // -----------------------------------------------------------------------------------------------------
        // @ Tayeur - POST
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/contacts/tayeur')
            .reply(() => {
                // Generate a new contact
                const newTayeur = {
                    id: FuseMockApiUtils.guid(),
                ...
                // Unshift the new contact
                this._tayeurs.unshift(newTayeur);

                // Return the response
                return [200, newTayeur];
            });
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('api/apps/contacts/model')
            .reply(() => {
                // Generate a new contact
                const newModel = {
                    id: FuseMockApiUtils.guid(),
        ...
        // @ Contact - GET
        // this._fuseMockApiService
        //     .onGet('api/apps/contacts/commande')
        //     .reply(({ request }) => {
        //         // Get the id from the params
        //         const id = request.params.get('id');

        //         // Clone the contacts
        //         const commandes = cloneDeep(this._commandes);
        ...
        // @ Contact - GET
        // this._fuseMockApiService
        //     .onGet('api/apps/contacts/client')
        //     .reply(({ request }) => {
        //         // Get the id from the params
        //         const id = request.params.get('id');
        ...
        // @ Contact - GET
        // this._fuseMockApiService
        //     .onGet('api/apps/contacts/tayeur')
        //     .reply(({ request }) => {
        //         // Get the id from the params
        //         const id = request.params.get('id');

        //         // Clone the contacts
        //         const tayeurs = cloneDeep(this._tayeurs);

        //         // Find the contact
        //         const tayeur = tayeurs.find(item => item.id === id);
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/contacts/clients')
            .reply(() => [200, cloneDeep(this._clients)]);
        // -----------------------------------------------------------------------------------------------------
        // @ Commandes - GET
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/contacts/commandes')
            .reply(() => [200, cloneDeep(this._commandes)]);
        // ----------------------------------------------------------------------------------------------
        // @ Tayeurs - GET
        // ----------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/contacts/tayeurs')
            .reply(() => [200, cloneDeep(this._tayeurs)]);
        ...
        //  -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/contacts/models')
            .reply(() => [200, cloneDeep(this._models)]);
